...
namespace z12.forms
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button1.Text = "ввести размер N * M";
            ...
            this.button5.Text = "Отсортировать массив в порядке убывания:";
            ...
            this.label4.Text = "Константы true и false: обращение к экземпляру \r\nкласса дает значение true, если " +
    "каждая строка \r\nмассива упорядоченна по возрастанию, \r\nиначе false.";
            // 
            // button2
            // 
